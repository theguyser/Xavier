...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // Force generation of the dialogueText object so we have valid data to work with. This is needed since LateUpdate() will be called before the dialogueText object has a chance to generated when entering play mode.
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    switch (linkInfo.GetLinkID())
                    {
                        case "id_01": // 100041637: // id_01
                                      ...
                                      //m_TextPopup_TMPComponent.dialogueText = k_LinkText + " ID 01";
                            break;
                        case "id_02": // 100041638: // id_02
                                      //m_TextPopup_RectTransform.position = worldPointInRectangle;
                                      //m_TextPopup_RectTransform.gameObject.SetActive(true);
                                      //m_TextPopup_TMPComponent.dialogueText = k_LinkText + " ID 02";
                            break;
                    }
                }
                #endregion
