...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            // Get a reference to the dialogueText component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get a reference to the camera rendering the dialogueText taking into consideration the dialogueText component type.
        ...
        void LateUpdate()
        {
            ...
            {
                // Reset all selections given we are hovering outside the dialogueText container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
