...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the dialogueText object's textInfo
            ...
            // Draw Quad around the bounds of the dialogueText
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the dialogueText.
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Draw dialogueText labels for metrics
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the dialogueText.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the dialogueText.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link dialogueText
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the dialogueText.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the dialogueText object.
        /// </summary>
        void DrawBounds()
        {
